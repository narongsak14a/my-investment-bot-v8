...
สร้างตาราง Markdown สรุปรายการสินทรัพย์/กองทุน **โดยต้องแสดงให้ครบทุกรายการที่มีอยู่ในชีท asset และ investment (รวมถึง kfcashrmf, es-fixedrmf, es-goldrmf-h)** โดยมีคอลัมน์ดังนี้:
